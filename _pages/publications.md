...
4.	**(field work)** *Laura C. Motta*, Joel D. Blum, Brian N. Popp, Jeffrey C. Drazen, and Hilary G. Close. Mercury Stable Isotopes in Flying Fish as a Monitor of Photochemical Degradation of Methylmercury in the Atlantic and Pacific 
Oceans. Marine Chemistry 2020, 223.
...
<img src="/assets/img/Field_work.JPG"
     width="100%"
     style="float: left; margin-right: 10px;" />

Collecting zooplankton on board of the R/V Kilo Moana at Station ALOHA using MOCNESS net system. (Motta et al., 2019)

<img src="/assets/img/computational_theoretical.png"
     width="100%"
     style="float: left; margin-right: 10px;" />

Photochemistry experiments of methylmercury within marine phytoplankton. (Kritee et al., 2018)


<img src="/assets/img/Photochemistry_experiments.jpeg"
     width="100%"
     style="float: left; margin-right: 10px;" />
Potential energy surface of photodissociation of methylmercury chloride. (Motta et al., 2020)